...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: `
      ...
      <div class="product-card">
        <a href="/products" class="product-card-link">
          <div class="product-card-image">
            <img src="/article_01_cost_failure_1766014194450.png" alt="EPHA Protection Program" />
          </div>
          <div class="product-card-content">
    ...
    `,
    image: "/article_01_cost_failure_1766014194450.png",
    category: "Management",
  ...
  },
  {
    ...
    excerpt: "Don't wait for catastrophic failure. Learn the 5 critical warning signs that your hydraulic hoses need immediate protection—and what happens if you ignore them.",
    content: `
      ...
      <div class="product-card">
        <a href="/products" class="product-card-link">
          <div class="product-card-image">
            <img src="/article_02_warning_signs_1766014240101.png" alt="Damage Zones" />
          </div>
          <div class="product-card-content">
    ...
    `,
    image: "/article_02_warning_signs_1766014240101.png",
    category: "Safety",
    author: "EPHA Editorial Team",
  ...
  },
  {
    ...
    excerpt: "Step-by-step installation guide for hydraulic hose protectors. Learn proper sizing, installation techniques, common mistakes to avoid, and best practices.",
    content: `
      ...
      <div class="product-card">
        <a href="/products" class="product-card-link">
          <div class="product-card-image">
            <img src="/article_03_installation_steps_1766014273581.png" alt="Installation Steps" />
          </div>
          <div class="product-card-content">
    ...
    `,
    image: "/article_03_installation_steps_1766014273581.png",
    category: "Maintenance",
  ...
  },
  {
    ...
    content: `
      ...
      <div class="product-card">
        <a href="/products" class="product-card-link">
          <div class="product-card-image">
            <img src="/article_04_temp_extremes_comparison_1766014310700.png" alt="Temperature Comparison" />
          </div>
          <div class="product-card-content">
    ...
    `,
    image: "/article_04_temp_extremes_comparison_1766014310700.png",
    category: "Maintenance",
  ...
  },
  {
    ...
    excerpt: "Real numbers from 500+ fleets prove preventative hose protection delivers 5,000-15,000% ROI. Calculate your savings with our interactive tool and see actual case studies.",
    content: `
      ...
      <div class="product-card">
        <a href="/products" class="product-card-link">
          <div class="product-card-image">
            <img src="/article_05_roi_infographic_1766014354884.png" alt="ROI Infographic" />
          </div>
          <div class="product-card-content">
    ...
    `,
    image: "/article_05_roi_infographic_1766014354884.png",
    category: "Management",
  ...
  },
  {
    ...
    excerpt: "Construction equipment faces unique hydraulic challenges—abrasion, heat, flex cycles. Learn why excavators and loaders fail, and how one contractor prevented 92% of failures.",
    content: `
      ...
      <div class="product-card">
        <a href="/products" class="product-card-link">
          <div class="product-card-image">
            <img src="/article_06_construction_before_after_1766014390026.png" alt="Construction Before and After" />
          </div>
          <div class="product-card-content">
    ...
    `,
    image: "/article_06_construction_before_after_1766014390026.png",
    category: "Case Study",
  ...
  },
  {
    ...
    excerpt: "Discover why American-made industrial products deliver superior quality, reliability, and value. Learn the real differences between U.S. and imported manufacturing in 2025.",
    content: `
      ...
      <div class="product-card">
        <a href="/products" class="product-card-link">
          <div class="product-card-image">
            <img src="/article_07_american_made_quality_1766014441807.png" alt="American Quality" />
          </div>
          <div class="product-card-content">
    ...
    `,
    image: "/article_07_american_made_quality_1766014441807.png",
    category: "Management",
  ...
  },
  {
    ...
    excerpt: "Step-by-step guide to implementing a fleet-wide preventative maintenance program that reduces hydraulic failures by 85%. Includes templates, checklists, and proven frameworks.",
    content: `
      ...
      <div class="product-card">
        <a href="/products" class="product-card-link">
          <div class="product-card-image">
            <img src="/article_08_process_diagram_1766014503797.png" alt="Process Diagram" />
          </div>
          <div class="product-card-content">
    ...
    `,
    image: "/article_08_process_diagram_1766014503797.png",
    category: "Management",
  ...
  },
  {
    ...
    excerpt: "Not all hose protection resists chemicals equally. Learn which industrial chemicals destroy standard hoses, material compatibility science, and protection solutions that actually work.",
    content: `
      ...
      <div class="product-card">
        <a href="/products" class="product-card-link">
          <div class="product-card-image">
            <img src="/article_09_chemical_immunity_comparison_1766014560199.png" alt="Chemical Comparison" />
          </div>
          <div class="product-card-content">
    ...
    `,
    image: "/article_09_chemical_immunity_comparison_1766014560199.png",
    category: "Safety",
  ...
  },
  {
    ...
    content: `
      ...
      <div class="product-card">
        <a href="/products" class="product-card-link">
          <div class="product-card-image">
            <img src="/article_10_roadside_crisis_vs_prevention_1766014611502.png" alt="Roadside Crisis" />
          </div>
          <div class="product-card-content">
    ...
    `,
    image: "/article_10_roadside_crisis_vs_prevention_1766014611502.png",
    category: "Management",
