...
export default function FleetIndustry() {
  return (
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-16">
              <div>
                <h2 className="text-3xl font-bold font-heading mb-8 text-slate-900">Rolling Out Fleet-Wide Protection</h2>
                <div className="space-y-8 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-300 before:to-transparent">
                  <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                    ...
                    <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-4 rounded-xl border border-slate-100 bg-slate-50 shadow-sm">
                      <div className="flex items-center justify-between space-x-2 mb-1">
                        <div className="font-bold text-slate-900">Phase 1: High-Risk Vehicles</div>
                        <time className="font-caveat font-medium text-primary">Weeks 1-4</time>
                      </div>
                      <div className="text-slate-500 text-sm">Identify vehicles with history of hose failures. Apply protection during scheduled maintenance.</div>
                    </div>
                  </div>
                  ...
                  <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                    ...
                    <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-4 rounded-xl border border-slate-100 bg-slate-50 shadow-sm">
                      <div className="flex items-center justify-between space-x-2 mb-1">
                        ...
                        <time className="font-caveat font-medium text-primary">Months 2-6</time>
                      </div>
                      <div className="text-slate-500 text-sm">Create vehicle-specific protection maps. Train technicians. Integrate into PM checklists.</div>
                    </div>
                  </div>
                  ...
                  <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                    ...
                    <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-4 rounded-xl border border-slate-100 bg-slate-50 shadow-sm">
                      <div className="flex items-center justify-between space-x-2 mb-1">
                        <div className="font-bold text-slate-900">Phase 3: Fleet-Wide Standard</div>
                        <time className="font-caveat font-medium text-primary">Month 6+</time>
                      </div>
                      <div className="text-slate-500 text-sm">All new vehicles protected before service. All vehicles protected at next major service. Track ROI.</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div>
                <h2 className="text-3xl font-bold font-heading mb-8 text-slate-900">Recommended Fleet Kits</h2>
